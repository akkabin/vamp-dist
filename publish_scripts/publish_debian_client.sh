...
../publish_scripts/bintray_debian.sh sid    ${PACKAGE} ${DISTRIBUTABLE} target ${VERSION} systemv main i386,amd64
../publish_scripts/bintray_debian.sh jessie ${PACKAGE} ${DISTRIBUTABLE} target ${VERSION} systemd main i386,amd64
